  ...
  return (
    <div id="projects" className=" min-h-screen h-fit">
      ...
      >
        ...
        <div className="text-left ml-36 mt-32 text-gray-700">
          ...
          <ul className="pl-8 text-base">
            ...
            <li><strong>Dynamic Event Display</strong>: The display dynamically updates every 5 seconds to show the current time, the day of the week, and the details of the next event. <br></br>
                If there are no upcoming events, a fallback message ("No upcoming events.") is shown.</li>
            <li><strong>Error Handling</strong>: The application includes robust error handling to deal with any issues that may arise when parsing event times or interacting with the Google Calendar API. <br></br>
          ...
          <ul className="pl-8 text-base">
            ...
            <li><strong>Display Library</strong>: The project uses the <code className="bg-gray-700 text-white px-1 rounded">Waveshare LCD_2inch</code> library to interface with the 2-inch display. <br></br>
